...
import { approveReturnBorrowBook } from './fn/approve-return-borrow-book';
import { ApproveReturnBorrowBook$Params } from './fn/approve-return-borrow-book';
import { BookResponse } from './types/book-response';
import { borrowBook } from './fn/borrow-book';
import { BorrowBook$Params } from './fn/borrow-book';
import { findAllBooks } from './fn/find-all-books';
import { FindAllBooks$Params } from './fn/find-all-books';
import { findAllBooksByOwner } from './fn/find-all-books-by-owner';
import { FindAllBooksByOwner$Params } from './fn/find-all-books-by-owner';
import { findAllBorrowedBooks } from './fn/find-all-borrowed-books';
import { FindAllBorrowedBooks$Params } from './fn/find-all-borrowed-books';
import { findAllReturnedBooks } from './fn/find-all-returned-books';
import { FindAllReturnedBooks$Params } from './fn/find-all-returned-books';
import { findBookById } from './fn/find-book-by-id';
import { FindBookById$Params } from './fn/find-book-by-id';
...
import { returnBorrowBook } from './fn/return-borrow-book';
import { ReturnBorrowBook$Params } from './fn/return-borrow-book';
import { saveBook } from './fn/save-book';
import { SaveBook$Params } from './fn/save-book';
import { updateArchivedStatus } from './fn/update-archived-status';
import { UpdateArchivedStatus$Params } from './fn/update-archived-status';
import { updateShareableStatus } from './fn/update-shareable-status';
import { UpdateShareableStatus$Params } from './fn/update-shareable-status';
import { uploadBookCoverPicture } from './fn/upload-book-cover-picture';
import { UploadBookCoverPicture$Params } from './fn/upload-book-cover-picture';
...
export class BookService extends BaseService {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveBook(params: SaveBook$Params, context?: HttpContext): Observable<{}> {
  ...
  static readonly ApproveReturnBorrowBookPath =
