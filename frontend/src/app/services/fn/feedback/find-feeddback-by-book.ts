...
export function findFeeddbackByBook(http: HttpClient, rootUrl: string, params: FindFeeddbackByBook$Params, context?: HttpContext): Observable<StrictHttpResponse<{
}>> {
